...
const steps = [
  {
    ...
    description: "15 minutes pour comprendre votre métier, vos douleurs et vos besoins",
    duration: "15 min",
  },
  {
    icon: FileText,
    ...
    description: "On choisit ensemble les modules adaptés à votre activité. Devis clair, sans surprise",
    duration: "2-3 jours",
  },
  {
    icon: Settings,
    number: "03",
    title: "1ère version livrée",
    description: "Votre secrétaire digitale est opérationnelle. Vous commencez déjà à gagner du temps",
    duration: "30 jours",
  },
  {
    icon: GraduationCap,
    number: "04",
    title: "Version finale + Formation",
    description: "Système complet, finalisé et optimisé. On vous forme pour que vous soyez autonome",
    duration: "60 jours",
  },
  {
    icon: Headphones,
    ...
    description: "On reste disponible. Votre secrétaire digitale évolue avec votre business",
    duration: "Inclus",
  },
];
